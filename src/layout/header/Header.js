  ...
  return (
    <header>
      <div className="container">
        <button
          onClick={() => setBurgerAct(!burgerAct)}
        ...
        <ul className="menu">
          <Link to="/">
            <li className=" top_list logo ">
              <span>I</span>Store<span>.</span>UK
            </li>
          </Link>
          <div className={burgerAct ? "burgerAd burgList" : "burgerAd "}>
            <li className="top_list top_list_size h">
              <Link to="/dostavka">Доставка і оплата</Link>{" "}
            </li>
            {/* <li className="top_list top_list_size h">
              <Link to="/garant">Гарантія</Link>
            </li> */}
            <li className="top_list top_list_size h">
              <Link to="/contacts">Контакти</Link>
            </li>
            <li className="top_list top_list_size h">
              <Link to="/ourPage">Про нас</Link>
            </li>

            {burgerAct ? (
              <li
                onClick={() => setBurgerProductList(!BurgerProductList)}
                className="top_list top_list_size h"
              >
                Список товарів
              </li>
            ) : (
        ...
        <section
          className={
            BurgerProductList ? "second_header ad add " : "second_header"
          }
        >
          <ul className="menu secondMenu">
            <li className="botom_list h " onClick={() => closeW()}>
              {" "}
            ...
            {BurgerProductList ? (
              <img
                src={row}
                onClick={() => setBurgerProductList(false)}
                className="row"
                alt=""
              />
            ) : (
          ...
          <div className="trash">
            <Link className="botom_list h" to="/basket">
              Кошик
            </Link>
          </div>
        </section>
